"""Phase 1 U8: eight untied blocks with exponent-1 hard-sequence CE."""
...
def token_training_loss(batch: TokenLossBatch) -> Tensor:
    """Emphasize high-loss answers while keeping weights out of the gradient."""
    ...
    weights = sequence_losses.detach().clamp_min(1e-8)
